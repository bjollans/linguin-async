...
def translate_story(query):
    ...
    if story["en"]:
        translated_text = translate_text(story["en"][:20], "en", target_language)
        story_translation["content"] = proof_read_translation(story["en"][:20],translated_text, target_language)
