...
from util.story_generation.orchestrate import generate_and_save_known_fiction_story, generate_and_save_mini_story, generate_and_save_mini_story_by_committee, generate_content_from_collection_name, generate_images_for_image_pending_stories, generate_one_round_of_content
...
if __name__ == "__main__":
    ...
    greek_stories=[
        ...
        "Tantalus and the Eternal Punishment",
        "Atlas and the World",
        "The Curse of the House of Atreus",
        "The Story of Antigone",
        "Sisyphus and the Eternal Punishment",
        ...
        "Lycaon and the Origin of Werewolves",
        "The Curse of Niobe",
        "The Story of Atalanta and the Golden Apples",
        "The Myth of Narcissus",
        "Oedipus and the Sphinx",
        "The Fates and the Thread of Life",
        "The Voyage of Argo",
        ...
        "The Judgment of Paris",
        "Daedalus, Inventor and Architect",
        ...
        "The Endymion Myth",
        "The Story of King Midas and Apollo",
        "The Giants' Revolt Against Olympus",
